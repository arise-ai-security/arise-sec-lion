    ...
    *,
    ...
    app = get_application(
        ...
        ApplicationConfig(
            ...
            step_timeout_seconds=settings.orchestration.step_timeout_seconds,
            worker_silence_timeout_seconds=settings.orchestration.worker_silence_timeout_seconds,
            no_progress_grace_seconds=settings.orchestration.no_progress_grace_seconds,
            no_progress_initial_grace_seconds=settings.orchestration.no_progress_initial_grace_seconds,
            no_progress_check_interval=settings.orchestration.no_progress_check_interval,
            pending_assessment_timeout_seconds=settings.orchestration.pending_assessment_timeout_seconds,
