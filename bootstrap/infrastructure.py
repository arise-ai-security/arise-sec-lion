...
from infrastructure.adapters.secbench_container import SecBenchContainerManager
...
class Infrastructure:
    ...
    secbench_container: SecBenchContainerPort
...
def get_infrastructure(config: InfrastructureConfig) -> Infrastructure:
    ...
    secbench_container = SecBenchContainerManager()
    ...
    return Infrastructure(
        ...
        secbench_container=secbench_container,
    )
