...
```
manifest.yaml ─┐
dataset.yaml ──┼─► run_matrix.py ─► runner "aris" ─► harness.run_ours ─► python main.py run …
configs/*.yaml ┘                                                                │
                                                                                ▼
